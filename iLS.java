    ...
    public static void main(String[] args) {
        ...
        while (looping) {
            ...
            for (int i = 1; i < 21; i++) {
                ...
                while (content.contains(randomizer)) {
                    randomizer = rand.nextInt(25);
                }
                content.add(randomizer);
                boolean failRepeat = true;
                while (failRepeat) {
                    ...
                    if (answer.equalsIgnoreCase(correctAnswer)) {
                        ...
                        if (answer.equalsIgnoreCase(choice1)) {
                            ...
                            int handleRand = randomizer;
                            randomizer = handleRand;
